...
vst_counts <- readRDS('Data/02_vst_10_filtered_limma_corrected.rds')
...
sizeGrWindow(12,9)
pdf(file = "Plots/bm_10_wgcna_clustering.pdf", width = 12, height = 9);
par(cex = 0.6);
par(mar = c(0,4,2,0))
...
collectGarbage()
save(datTraits, vst_counts, file = "Data/bm_10_wgcna_data_input.RData")
...
save(MEs, moduleLabels, moduleColors, geneTree,
     file = "Data/bm_10_wgcna_network.RData")
