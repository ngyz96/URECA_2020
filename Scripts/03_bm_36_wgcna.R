...
vst_counts <- readRDS('Data/02_vst_36_filtered_limma_corrected.rds')
...
sizeGrWindow(12,9)
pdf(file = "Plots/bm_36_wgcna_clustering.pdf", width = 12, height = 9);
par(cex = 0.6);
par(mar = c(0,4,2,0))
...
#clinical data
bm_36_coldata <- readRDS('Data/02_bm_36_data.rds')
reduced_coldata <- bm_36_coldata[, c('index_id', 'batch', 'RIN', 'PMI', 'AOD', 'SEX', 'NP.1', 'CDR', 'PlaqueMean', 'bbscore', 'Apo1', 'Apo2')]
reduced_coldata$SEX <- as.factor(reduced_coldata$SEX) #F is 1, M is 2
reduced_coldata$batch <- plyr::mapvalues(reduced_coldata$batch, from = c('E007C014', 'K75rC014', 'P60C014', 'P62C014', 'S107B355', 'S108B355', 'S109B355', 'S111B394', 'S112B394'), 
                to = c(1, 2, 3, 4, 5, 6, 7, 8, 9))
reduced_coldata$NP.1_mapped <- plyr::mapvalues(reduced_coldata$NP.1, c('1', '2', '3', '4'), c("1", "4", "3", '2'))
...
collectGarbage()
save(datTraits, vst_counts, file = "Data/bm_36_wgcna_data_input.RData")
...
net = blockwiseModules(vst_counts, power = 10, maxBlockSize = 10000,
                       TOMType = "signed", minModuleSize = 30,
                       reassignThreshold = 0, mergeCutHeight = 0.25,
                       numericLabels = TRUE, pamRespectsDendro = FALSE,
                       saveTOMs = TRUE,
                       saveTOMFileBase = "bm_36TOM_signed",
                       verbose = 3)
...
save(MEs, moduleLabels, moduleColors, geneTree,
     file = "Data/bm_36_wgcna_network_signed.RData")
