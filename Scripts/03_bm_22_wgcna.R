...
vst_counts <- readRDS('Data/02_vst_22_filtered_limma_corrected.rds')
...
sizeGrWindow(12,9)
pdf(file = "Plots/bm_22_wgcna_clustering.pdf", width = 12, height = 9);
par(cex = 0.6);
par(mar = c(0,4,2,0))
...
#clinical data
bm_22_coldata <- readRDS('Data/02_bm_22_data.rds')
reduced_coldata <- bm_22_coldata[, c('index_id', 'batch', 'RIN', 'PMI', 'AOD', 'SEX', 'NP.1', 'CDR', 'PlaqueMean', 'bbscore', 'Apo1', 'Apo2')]
...
collectGarbage()
save(datTraits, vst_counts, file = "Data/bm_22_wgcna_data_input.RData")
...
save(MEs, moduleLabels, moduleColors, geneTree,
     file = "Data/bm_22_wgcna_network.RData")
